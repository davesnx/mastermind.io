$(function() {
    ...
    var $loginPage = $('.login.page').eq(1); // The login page
    var $matchPage = $('.login.page').eq(0); // The login page
    ...
    function addMatchMessage(data) {
        var message = 'you joined ' + data.matchname + '\'s matchname';
        log(message);
    }
    ...
    socket.on('login', function(data) {
        ...
        var message = "Welcome to MasterMind.IO Game";
        log(message, {
            prepend: true
        });
    ...
    socket.on('log match', function(data) {
        addMatchMessage(data);
    });

    socket.on('view matchnames', function(data) {
        addMatchNames(data);
    });
    ...
    socket.on('begin match', function(data) {
